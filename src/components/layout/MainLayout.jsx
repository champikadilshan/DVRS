...
// Add the AWS Logo component here
const AWSLogo = () => (
  <svg
  ...
  const navigationItems = [
    {
      ...
      icon: Layers,
      path: '/repositories',
      description: 'Manage and scan your ECR repositories',
    },
    {
      name: 'Security',
      icon: Shield,
  ...
  return (
    <div className="h-screen flex bg-[#f5f5f7]">
      ...
      <div
        ...
        } w-64 bg-white/80 backdrop-blur-2xl border-r border-gray-200 transition-transform duration-300 ease-in-out z-30`}
      >
        <div className="h-full flex flex-col">
            ...
            {navigationItems.map((item) => {
              ...
              return (
                <button
                  ...
                  className="w-full group flex items-center px-3 py-3 rounded-xl hover:bg-blue-50 transition-colors duration-150"
                >
          ...
          <div className="p-4 border-t border-gray-200">
            <button
              ...
              className="w-full flex items-center px-3 py-2 rounded-lg hover:bg-red-50 text-red-600 transition-colors duration-150"
            >
      ...
      <div className="flex-1 flex flex-col min-h-screen ml-64">
        {/* Top Navigation */}
        <header className="bg-white/80 backdrop-blur-xl border-b border-gray-200 h-16 flex items-center px-6 sticky top-0 z-20">
          <button
            ...
            <div className="flex items-center space-x-4">
              <div className="text-right">
                <p className="text-sm font-medium text-gray-900">
                  {awsCredentials?.accountId || 'AWS Account'}
                </p>
